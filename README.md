...
6. Create a first page named `Brainstem`.
7. Paste in the Brainstem generated by `p2-kit`.
8. Give the agent the P2 URL and ask it to load the brain.

For a first version, a skill can help by opening the MC tool for the user, preparing the recommended site name, drafting the Brainstem, and then verifying the created P2 once the user provides the URL.
